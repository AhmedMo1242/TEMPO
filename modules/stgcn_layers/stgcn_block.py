...
class GCN_unit(nn.Module):
    ...
    def forward(self, x, len_x):
        ...
        # Stability: Clamp A and normalize input to einsum to prevent BmmBackward Nan
        A_stable = torch.clamp(self.A, min=-10.0, max=10.0)
        x = torch.einsum("nkctv,kvw->nctw", (x, A_stable)).contiguous()
